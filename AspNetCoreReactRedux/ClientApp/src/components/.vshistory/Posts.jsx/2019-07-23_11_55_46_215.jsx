                            ...
                            <Card >
                                <CardActionArea>
                                    <CardContent>
                                        ...
                                        <Typography component="p">Genre: {post.genre}</Typography>
                                        <Typography component="p"><B>Publish date: {post.publish_date}</Typography>
                                        <Typography component="p">Price: {post.price}</Typography>
                                    </CardContent>
                                </CardActionArea>
                            </Card>
                        </Grid>
